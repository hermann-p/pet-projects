...
var or__4580__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469).cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__10672 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__10672;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__4568__auto__ = id;
...
if(cljs.core.truth_((function (){var or__4580__auto__ = id;
if(cljs.core.truth_(or__4580__auto__)){
return or__4580__auto__;
} else {
return cs;
...
hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__5178__auto__,writer__5179__auto__,opt__5180__auto__){
return cljs.core._write.call(null,writer__5179__auto__,"hipo.hiccup/Sentinel");
});
...
var G__10674 = (function (){var f = cljs.core.first.call(null,s);
if(cljs.core.truth_((function (){var or__4580__auto__ = hipo.hiccup.literal_QMARK_.call(null,f);
if(cljs.core.truth_(or__4580__auto__)){
return or__4580__auto__;
} else {
...
var G__10675 = cljs.core.rest.call(null,s);
v = G__10674;
s = G__10675;
continue;
} else {
...
var G__10676 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.hiccup.conjs_BANG_.call(null,acc,f):((!((f == null)))?cljs.core.conj_BANG_.call(null,acc,f):acc
));
var G__10677 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__10676;
v__$1 = G__10677;
continue;
}
